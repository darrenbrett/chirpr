...
export class FeedComponent implements OnInit {
  ...
  { body: 'People think that computer science is the art of geniuses but the actual reality is the opposite, just many people doing things that build on each other, like a wall of mini stones', author: '../public/avatars/Glen', avatar: 'glen.jpg', date: new Date(), rechirps: ['Joe', 'Mary'], favorites: [] },
